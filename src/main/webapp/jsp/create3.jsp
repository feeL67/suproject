...
<s:message code="label.rice"/>:
 <img src="/images/ingredients/rice.jpg" style="width: 10rem"class="img-thumbnail" alt=<s:message code="label.rice"/>>
...
<p class="text-danger"><s:message code="label.name"/>: <input type="text" name="name">
