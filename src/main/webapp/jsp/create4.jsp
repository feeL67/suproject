...
<p class="text-center text-danger"><s:message code="label.cover"/>:
...
<h5><p class="text-center text-primary"><s:message code="label.total"/>: ${roll.price}BYN/${roll.weight} gr.</h5>
