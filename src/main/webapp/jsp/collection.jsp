...
<center>
                <i><h1><p class="text-danger text-center"><s:message code="label.rollCollection"/>:<hr></h1></i>
  <table>
    <tr align="center">
  ...
  <c:forEach items="${rolls}" var="roll">
       <tr align="center">
             ...
             <td> ${roll.price}</td>
              ...
              <a href="/menu">
              <button type="button" class="btn btn-outline-danger"><s:message code="label.menu"/></button></a></br>
</center>
</body>
</html>